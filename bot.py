...
TARGET_LINK = os.environ.get("TARGET_LINK", "https://t.me")
PORT = int(os.environ.get("PORT", 8080))

# --- Fix asyncio issue (IMPORTANT for Python 3.14) ---
try:
...
async def start_cmd(client, message):
    ...
    if not user:
        ...
        if referrer_id and referrer_id != user_id:
            ...
            try:
                await bot.send_message(referrer_id, "🎉 New Referral Join!")
            except:
                pass
